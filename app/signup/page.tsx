  ...
  return (
    <div className="h-screen flex-col text-white bg-gray-900 flex justify-center items-center">
      ...
      <form className="min-w-[500px] flex flex-col gap-2">
        ...
        <input type="text" id="username" placeholder="mussadiqkhan" name="username" onChange={handleChange} value={user.username} className="outline-none w-full border border-gray-500 px-3 py-1" />
